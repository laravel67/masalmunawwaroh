...
use App\Models\Struktur as Struk;
...
//             $struktur = Struk::where('jabatan_id', $this->idjabatan[$index])->first();
...
//         return redirect()->route('profilemas.struktur')->with('success', 'Struktur berhasil diperbarui!');
//     }
