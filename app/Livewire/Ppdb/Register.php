...
class Register extends Component
{
    ...
    public function render()
    {
        ...
        if ($tahun) {
            $tahunAjran = "tahun-ajaran-" . $tahun->name;
        } else {
            $tahunAjran = "tahun-ajaran-default"; // Provide a default value or handle the error appropriately
        }
        $shareComponent = new Share();
        $shareComponent->page('https://depatiagung.my.id/ppdb/formulir-pendaftaran/' . $tahunAjran)->facebook()->twitter()->linkedin()->telegram()->whatsapp();
        return view('livewire.ppdb.register', compact('shareComponent'));
    }
