{{-- <x-content>
    <x-profile-header/>
    <div class="container-fluid bg-white" data-aos="fade-up" data-aos-duration="500">
...
<x-content>
    ...
    <div class="card mb-3" data-aos="fade-up" data-aos-duration="500">
                ...
                <div class="row justify-content-center">
                    <div class="text-center">
                        ...
                        <div class="list-group">
                            <div class="p-0 px-1 list-group-item list-group-item-action bg-success text-light">
                                {{ $yayasan->name ?? '' }}
                            </div>
        ...
        {{-- <div class="card-header border-none p-0 bg-white text-center mt-5">
            <strong class="bg-warning text-light p-2">UNIT</strong>
        </div>
        ...
        {{-- Empat --}}
        {{-- <div class="card-header border-none p-0 bg-white text-center mt-5">
            <strong class="bg-secondary text-light p-2">URUSAN</strong>
        </div>
            ...
            <div class="col-md-3 col-6 mb-3">
                <div class="row justify-content-center">
                    <div class="text-center">
                        ...
                        @endif
                        <div class="list-group">
                            <div class="p-0 px-1 list-group-item list-group-item-action bg-secondary text-white">
                                {{ $pengasuhPutra->name ?? '' }}
                            </div>
                            <div class="p-0 px-1 list-group-item list-group-item-action">
        ...
        {{-- <div class="card-header border-none p-0 bg-white text-center mt-5">
            <strong class="bg-info text-light p-2">{{ __('JABATAN') }}</strong>
        </div>
        <div class="row justify-content-center mb-2" data-aos="fade-up" data-aos-anchor-placement="bottom-bottom"
            data-aos-duration="1000">
            <div class="col-md-3 col-6 mb-3">
        ...
        <div class="card-header border-none p-0 bg-white text-center mt-5">
            <strong class="bg-danger text-light p-2">MAJELIS GURU</strong>
        </div>
