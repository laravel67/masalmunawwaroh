    ...
    <div class="row">
        ...
        {{-- <div class="col-md-4 order-md-last">
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="my-md-3 p-3 bg-white">
                        <h6 class="pb-2 mb-0 text-success card-header mx-0">{{ __('Sambutan Kepala Madrasah Aliyah')
                            }}
                        </h6>
                        <div class="block">
                            <div class="p-3">
                    ...
                    <div id="slideGaleri" class="carousel slide my-5 my-md-3 bg-white rounded shadow-sm"
                        ...
                        <div class="carousel-inner text-center">
                            ...
                            <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                                <a href="">
                                    <img src="{{ asset('storage/'.$item->image) }}" class="img-top"
        ...
        <div class="col-md-12">
            <div class="my-5 rounded-0 shadow-none">
                <h5 class="pb-2 mb-0 text-success card-header">{{ __('Berita Terbaru') }}</h5>
                ...
                <div class="text-right mt-2">
                    <a href="{{ route('posts') }}" class="btn btn-success btn-sm"><i class="fa-regular fa-newspaper"></i> {{
                        __('Semua Berita') }}</a>
                </div>
            </div>
        </div>
