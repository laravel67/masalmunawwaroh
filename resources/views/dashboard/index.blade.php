<x-main>
    <div class="row">
        <x-widget title="Pengguna" icon="users" bg="info" value="{{ $users ?? 0 }}" />
        ...
        <x-widget title="Siswa" icon="users" bg="light" value="{{ $student }}" />
        <x-widget title="Ekstra Kulikuler" icon="star" bg="dark" value="{{ $star ?? 0 }}" />
    </div>
    {{-- <div class="row">
        <div class="col-md-12">
          <div class="card">
